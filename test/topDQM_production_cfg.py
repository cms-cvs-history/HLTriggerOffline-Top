...
process.DiMuonMu17_TkMu8.setup.directory = cms.string("Physics/Top/DiMuonMu17_TkMu8/")
...
process.DiElectronDQM.setup.directory = cms.string("Physics/Top/DiElectron/")
...
process.ElecMuonMu17Ele8.setup.directory = cms.string("Physics/Top/ElecMuonMu17Ele8/")
